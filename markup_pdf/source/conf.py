...
html_title = "HTML Output for PDF"
...
# pixels large.
# currently SVG to show what the ICO should look like, if there was one
...
htmlhelp_basename = 'HTML Output for PDF'
